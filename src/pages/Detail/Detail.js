            ...
            >
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-4">
                        ...
                        <h1 style={{ marginLeft: '5%' }} className="text-red-400 text-2xl">
                            <Rate allowHalf defaultValue={filmDetail.danhGia / 2}
                                style={{ color: "#78ed78", fontSize: 30 }} /></h1>
                                            ...
                                            {htr.cumRapChieu?.map((cumRap, index) => {
                                                return <div key={index}>
                                                    <div className="flex flex-row">
                                                        <img style={{ width: 60, height: 60 }} src={'https://s3img.vcdn.vn/123phim/2018/09/ddc-dong-da-15379624326697.jpg'} alt="hinhAnhRap" />
                                                        <div className="ml-2">
