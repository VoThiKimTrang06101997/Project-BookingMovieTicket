...
function Checkout(props) {
    ...
    const renderSeats = () => {
        return danhSachGhe.map((ghe, index) => {
            ...
            // Kiểm tra từng ghé render xem có phải ghế khách đặt hay không
            ...
            return <Fragment key={index}>
                ...
                }} disabled={ghe.daDat || classGheKhachDat !== ''} className={`ghe ${classGheVip} ${classGheDaDat} ${classGheDangDat} 
                ${classGheDaDuocDat} ${classGheKhachDat} text-center`} key={index}>
                    {ghe.daDat ? classGheDaDuocDat !== '' ? <UserOutlined style={{ marginBottom: 5, fontWeight: "bold" }} /> : <CloseOutlined style={{ marginBottom: 5, fontWeight: "bold" }} /> : classGheKhachDat !== '' ? < SmileOutlined
                        style={{ marginBottom: 5, fontWeight: "bold" }} /> : ghe.stt}
        ...
        <div className="min-h-screen mt-5">
            <div className="grid grid-cols-12">
                ...
                <div className="col-span-3">
                    ...
                    <div className="flex flex-row my-5">
                        <div className="w-4/5">
                            ...
                            {_.sortBy(danhSachGheDangDat, ['stt']).map((gheDangDat, index) => {
                                return <span key={index} className="text-green-500 text-xl">{gheDangDat.stt} </span>
                            })}
                        </div>
                    ...
                    <hr />
                    <div className="mb-0 h-full flex flex-col justify-items-end items-center" style={{ marginBottom: 0 }}>
                        <div onClick={() => {
                            const thongTinDatVe = new ThongTinDatVe();

                            thongTinDatVe.maLichChieu = props.match.params.id;
                            thongTinDatVe.dangSachVe = danhSachGheDangDat;
        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-purple-600 text-2xl">Lịch sử Đặt vé Khách hàng</h1>
